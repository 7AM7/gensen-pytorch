...
class EmotionClassification(FineTuningBehaviour):
    def __init__(self, training_data_path, test_data_path):
        ...
        self.num_classes = 11
        self.task_type = "multilabel"  # multiclass | multilabel | regression | dual (e.g: xnli, q2q)
        self.finetune = True
        ...
        self.eval_metric = "Jaccard"  # F1-macro | Jaccard | Pearson | Matthews

    def prepare(self):
        train_data = pd.read_csv(
            self.training_data_path, sep="\t"
        )
